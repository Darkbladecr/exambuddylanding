...
return array(
	...
	"params" => array(
		array(
			...
			"holder" => "div",
			"class" => "",
			"heading" => esc_html__("Dividing Height", "salient-core"),
			"param_name" => "custom_height",
			"description" => esc_html__("If you would like to control the specific number of pixels your divider is, enter it here. Don't enter \"px\", just the number e.g. \"20\"", "salient-core"),
		),
		array(
			"type" => "dropdown",
			"holder" => "div",
