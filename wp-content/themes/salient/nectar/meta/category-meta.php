 ...
 function nectar_taxonomy_edit_meta_field($term) {
	 ...
	 <tr class="form-field">
		 ...
		 <td>
			 ...
			 <img class="nectar-media-preview" id="screenshot-category_thumbnail_image" src="<?php echo esc_attr( $term_meta['category_thumbnail_image'] ) ? esc_attr( $term_meta['category_thumbnail_image'] ) : ''; ?>" />
	 ...
	 <tr class="form-field">
		 ...
		 <td>
			 ...
			 <img class="nectar-media-preview" id="screenshot-category_image" src="<?php echo esc_attr( $term_meta['category_image'] ) ? esc_attr( $term_meta['category_image'] ) : ''; ?>" />
